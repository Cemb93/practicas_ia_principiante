# 1. Cargar el fichero de excel 'dataset_bigdata' ty nombrarlo 'df_practica5'
...
import pandas as pd
# R/1.
ruta_bd = 'C:\Users\USUARIO\Desktop\PROGRAMACION\Artificial Inteligent\Nivel Basico\Base de datos/dataset_bigdata.xlsx'
df_practica5 = pd.read_excel(ruta_bd)
print(f'******Punto 1******\n{df_practica5}')
